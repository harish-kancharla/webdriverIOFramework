...
exports.config = {
    ...
    baseUrl: 'http://pocafe.itsbeta.net/#/auth',
    //
    ...
    cucumberOpts: {
        ...
        format: ['pretty'], // <string[]> (type[:path]) specify the output format, opz  tionally supply PATH to redirect formatter output (repeatable)
